...
def run_swiglu(
    ...
    from cs336_basics.swiglu import my_swiglu
    return my_swiglu(w1_weight,w2_weight,w3_weight,in_features)
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.multihead_self_attention import my_run_multihead_self_attention
    return my_run_multihead_self_attention(d_model, num_heads, q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight, in_features)
...
def run_rope(
    ...
    """
    from cs336_basics.rope import my_rope
    return my_rope(d_k, theta, max_seq_len, in_query_or_key, token_positions)
